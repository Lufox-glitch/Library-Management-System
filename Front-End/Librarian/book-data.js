const BOOKS_DATABASE = [
  { name: "The Hunger Games", author: "Suzanne Collins", publisher: "Alfa", pages: 478, serial: 1, summary: "A dystopian novel about survival and revolution." },
  { name: "Harry Potter", author: "J.K. Rowling", publisher: "Beta", pages: 398, serial: 2, summary: "A young wizard's journey at Hogwarts School of Witchcraft and Wizardry." },
  { name: "To Kill a Mockingbird", author: "Harper Lee", publisher: "Omega", pages: 685, serial: 3, summary: "A classic exploring racial injustice in the Deep South." },
  { name: "Pride and Prejudice", author: "Jane Austen", publisher: "Sky", pages: 425, serial: 4, summary: "A romantic novel about manners, marriage, and morality." },
  { name: "Twilight", author: "Stephenie Meyer", publisher: "Sun", pages: 556, serial: 5, summary: "A modern vampire romance that launched a pop-culture phenomenon." },
  { name: "The Book Thief", author: "Markus Zusak", publisher: "Child", pages: 475, serial: 6, summary: "A moving story of a girl who steals books in Nazi Germany." },
  { name: "Narnia", author: "C.S. Lewis", publisher: "Alfa", pages: 358, serial: 7, summary: "A fantasy series set in the magical land of Narnia." },
  { name: "Animal Farm", author: "George Orwell", publisher: "Dog", pages: 277, serial: 8, summary: "A political allegory about power and corruption." },
  { name: "Les Misérables", author: "Victor Hugo", publisher: "Dog", pages: 369, serial: 9, summary: "An epic tale of love, justice, and redemption in 19th-century France." },
  { name: "The Alchemist", author: "Paulo Coelho", publisher: "Omega", pages: 247, serial: 10, summary: "A philosophical story of a shepherd's quest to realize his personal legend." },
  { name: "The Help", author: "Kathryn Stockett", publisher: "Clock", pages: 159, serial: 11, summary: "A story about African American maids working in white households during the 1960s." },
  { name: "Charlotte's Web", author: "E.B. White", publisher: "Book", pages: 437, serial: 12, summary: "A children's classic about friendship between a pig and a clever spider." },
